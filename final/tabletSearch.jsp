...
<body>
<h1>Enter Tablet Attributes</h1>
<br>
<br>
	<form method="post" action="jtitemQuery.jsp">
	<table>
	<tr>
	<td>Tablet Brand</td><td><input type="text" name="brand"></td>
	</tr>
	<tr>    
	<td>Tablet Year</td><td><input type="text" name="year"></td>
	</tr>
	<tr>
	<td>Tablet Type</td><td><input type="text" name="type"></td>
	</tr>
	<tr>
	<td>Screen Size</td><td><input type="text" value = "0" name="screensize"></td>
	</tr>
	<tr>
	...
	<tr>
	<td><input type = "hidden" name = "itemcat" value = "tablet"></td>
	</tr>
	</table>
