...
<br>
	<form method="post" action="crMakeRequest.jsp">
	<table>
	<tr>
		<td>Question ID:</td><td><input type="number" name="questionID"></input></td>
	<tr>
		<td>Input Response:</td><td><textarea name="response" rows="10" cols="30"></textarea></td>
	</tr>
...
<br>
<input type="button" value="Back to Your Page" onclick="window.location='crLanding.jsp'">
